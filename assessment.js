...
const tweetDivided = document.getElementById('tweet-area');
     ...
     */
    function removeAllCildren(element) {
...
assessmentButton.onclick = () => {
    ...
    if (userName.length === 0) { // 名前が空の時きは処理を終了する
    return;
    }
    console.log(userName);
    //TODO 診断結果表示エリアの作成
    removeAllCildren(resultDivided);
...
const answers = [
    ...
    '{userName}のいいところはユニークさです。{userName}だけののその特徴が皆を楽しくさせます。',
